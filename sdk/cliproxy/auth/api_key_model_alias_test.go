...
func TestLookupAPIKeyUpstreamModel(t *testing.T) {
	cfg := &internalconfig.Config{
		GeminiKey: []internalconfig.GeminiKey{
			{
				APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "k"}}, BaseURL: "https://example.com",
...
func TestAPIKeyModelAlias_ConfigHotReload(t *testing.T) {
	cfg := &internalconfig.Config{
		GeminiKey: []internalconfig.GeminiKey{
			{
				APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "k"}}, Models: []internalconfig.GeminiModel{{Name: "gemini-2.5-pro-exp-03-25", Alias: "g25p"}},
			},
		},
	}
	...
	mgr.SetConfig(&internalconfig.Config{
		GeminiKey: []internalconfig.GeminiKey{
			{
				APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "k"}}, Models: []internalconfig.GeminiModel{{Name: "gemini-2.5-flash", Alias: "g25p"}},
			},
		},
	})
...
func TestAPIKeyModelAlias_MultipleProviders(t *testing.T) {
	cfg := &internalconfig.Config{
		GeminiKey: []internalconfig.GeminiKey{{APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "gemini-key"}}, Models: []internalconfig.GeminiModel{{Name: "gemini-2.5-pro", Alias: "gp"}}}},
		ClaudeKey: []internalconfig.ClaudeKey{{APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "claude-key"}}, Models: []internalconfig.ClaudeModel{{Name: "claude-sonnet-4", Alias: "cs4"}}}},
		CodexKey:  []internalconfig.CodexKey{{APIKeyEntries: []internalconfig.ProviderAPIKeyEntry{{APIKey: "codex-key"}}, Models: []internalconfig.CodexModel{{Name: "o3", Alias: "o"}}}},
	}
