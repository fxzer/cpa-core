...
import (
	...
	"github.com/fxzer/cpa-core/v7/internal/api"
	...
	"github.com/fxzer/cpa-core/v7/internal/runtime/executor"
	"github.com/fxzer/cpa-core/v7/internal/util"
	"github.com/fxzer/cpa-core/v7/internal/watcher"
	"github.com/fxzer/cpa-core/v7/internal/watcher/diff"
	"github.com/fxzer/cpa-core/v7/internal/wsrelay"
...
func (s *Service) resolveConfigClaudeKey(auth *coreauth.Auth) *config.ClaudeKey {
	...
	for i := range s.cfg.ClaudeKey {
		...
		if entry.MatchesAPIKey(attrKey, attrBase) {
			return entry
		}
	}
	return nil
...
func (s *Service) oauthExcludedModels(provider, authKind string) []string {
	...
	return cfg.OAuthExcludedModels.Patterns(providerKey)
}
