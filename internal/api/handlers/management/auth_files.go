...
import (
	...
	geminiAuth "github.com/fxzer/cpa-core/v7/internal/auth/gemini"
	"github.com/fxzer/cpa-core/v7/internal/auth/kimi"
	xaiauth "github.com/fxzer/cpa-core/v7/internal/auth/xai"
...
func (h *Handler) GetAuthFileModels(c *gin.Context) {
	...
	if parseUpstreamQuery(c.Query("upstream")) && authRecord != nil {
		models = resolveUpstreamAuthFileModels(h.cfg, authRecord, models)
	}
