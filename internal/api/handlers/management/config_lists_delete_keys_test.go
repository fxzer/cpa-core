	...
	h := &Handler{
		cfg: &config.Config{
			GeminiKey: []config.GeminiKey{
				{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "shared-key"}}, BaseURL: "https://a.example.com"},
				{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "shared-key"}}, BaseURL: "https://b.example.com"},
			},
		},
	...
	h := &Handler{
		cfg: &config.Config{
			ClaudeKey: []config.ClaudeKey{
				{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "shared-key"}}, BaseURL: ""},
				{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "shared-key"}}, BaseURL: "https://claude.example.com"},
			},
		},
		configFilePath: writeTestConfigFile(t),
	}
