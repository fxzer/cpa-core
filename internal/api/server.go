...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/request-events/aggregate", s.mgmt.GetRequestEventsAggregate)
		mgmt.GET("/request-events/distinct", s.mgmt.GetRequestEventsDistinct)
		...
		mgmt.GET("/auth-files/models-config", s.mgmt.GetAuthFileModelsConfig)
		mgmt.PATCH("/auth-files/models-config", s.mgmt.PatchAuthFileModelsConfig)
