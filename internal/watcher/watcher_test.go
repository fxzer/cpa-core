...
import (
	...
	"github.com/fxzer/cpa-core/v7/internal/watcher/synthesizer"
...
func TestBuildAPIKeyClientsCounts(t *testing.T) {
	cfg := &config.Config{
		GeminiKey: []config.GeminiKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g1"}}}, {APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g2"}}}},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v1"}}},
		},
		ClaudeKey: []config.ClaudeKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c1"}}}},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x1"}}, BaseURL: "https://api.openai.com"},
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x2"}}, BaseURL: "https://api.openai.com"},
		},
