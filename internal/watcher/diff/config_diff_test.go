...
func TestBuildConfigChangeDetails(t *testing.T) {
	oldCfg := &config.Config{
		...
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "old"}}, BaseURL: "http://old", ExcludedModels: []string{"old-model"}},
		},
		...
		OAuthExcludedModels: config.OAuthExcludedModelsConfigFromLegacy(map[string][]string{
			"providerA": {"m1"},
		}),
	...
	newCfg := &config.Config{
		...
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "old"}}, BaseURL: "http://old", ExcludedModels: []string{"old-model", "extra"}},
		},
		AmpCode: config.AmpCode{
...
func TestBuildConfigChangeDetails_GeminiVertexHeadersAndForceMappings(t *testing.T) {
	oldCfg := &config.Config{
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g1"}}, Headers: map[string]string{"H": "1"}, ExcludedModels: []string{"a"}},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v1"}}, BaseURL: "http://v-old", Models: []config.VertexCompatModel{{Name: "m1"}}},
		},
		AmpCode: config.AmpCode{
	...
	newCfg := &config.Config{
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g1"}}, Headers: map[string]string{"H": "2"}, ExcludedModels: []string{"a", "b"}},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v1"}}, BaseURL: "http://v-new", Models: []config.VertexCompatModel{{Name: "m1"}, {Name: "m2"}}},
		},
		AmpCode: config.AmpCode{
...
func TestBuildConfigChangeDetails_ModelPrefixes(t *testing.T) {
	oldCfg := &config.Config{
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g1", ProxyURL: "http://gp"}}, Prefix: "old-g", BaseURL: "http://g"},
		},
		ClaudeKey: []config.ClaudeKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c1", ProxyURL: "http://cp"}}, Prefix: "old-c", BaseURL: "http://c"},
		},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x1", ProxyURL: "http://xp"}}, Prefix: "old-x", BaseURL: "http://x"},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v1", ProxyURL: "http://vp"}}, Prefix: "old-v", BaseURL: "http://v"},
		},
	}
	newCfg := &config.Config{
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g1", ProxyURL: "http://gp"}}, Prefix: "new-g", BaseURL: "http://g"},
		},
		ClaudeKey: []config.ClaudeKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c1", ProxyURL: "http://cp"}}, Prefix: "new-c", BaseURL: "http://c"},
		},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x1", ProxyURL: "http://xp"}}, Prefix: "new-x", BaseURL: "http://x"},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v1", ProxyURL: "http://vp"}}, Prefix: "new-v", BaseURL: "http://v"},
		},
	}
...
func TestBuildConfigChangeDetails_FlagsAndKeys(t *testing.T) {
	oldCfg := &config.Config{
		...
		ClaudeKey:              []config.ClaudeKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c1"}}}},
		CodexKey:               []config.CodexKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x1"}}}},
	...
	newCfg := &config.Config{
		...
		ClaudeKey: []config.ClaudeKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c1", ProxyURL: "http://p"}}, BaseURL: "http://new", Headers: map[string]string{"H": "1"}, ExcludedModels: []string{"a"}},
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c2"}}},
		},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x1", ProxyURL: "http://px"}}, BaseURL: "http://x", Headers: map[string]string{"H": "2"}, ExcludedModels: []string{"b"}},
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x2"}}},
		},
		AmpCode: config.AmpCode{
			UpstreamAPIKey:                "",
			RestrictManagementToLocalhost: true,
...
func TestBuildConfigChangeDetails_AllBranches(t *testing.T) {
	oldCfg := &config.Config{
		...
		QuotaExceeded:          config.QuotaExceeded{SwitchProject: false, SwitchPreviewModel: false, AntigravityCredits: false},
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g-old", ProxyURL: "http://gp-old"}}, BaseURL: "http://g-old", Headers: map[string]string{"A": "1"}},
		},
		ClaudeKey: []config.ClaudeKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c-old", ProxyURL: "http://cp-old"}}, BaseURL: "http://c-old", Headers: map[string]string{"H": "1"}, ExcludedModels: []string{"x"}},
		},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x-old", ProxyURL: "http://xp-old"}}, BaseURL: "http://x-old", Headers: map[string]string{"H": "1"}, ExcludedModels: []string{"x"}},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v-old", ProxyURL: "http://vp-old"}}, BaseURL: "http://v-old", Headers: map[string]string{"H": "1"}, Models: []config.VertexCompatModel{{Name: "m1"}}},
		},
		AmpCode: config.AmpCode{
		...
		OAuthExcludedModels: config.OAuthExcludedModelsConfigFromLegacy(map[string][]string{"p1": {"a"}}),
		OpenAICompatibility: []config.OpenAICompatibility{
			{
				Name: "prov-old",
				APIKeyEntries: []config.OpenAICompatibilityAPIKey{
	...
	newCfg := &config.Config{
		...
		QuotaExceeded:          config.QuotaExceeded{SwitchProject: true, SwitchPreviewModel: true, AntigravityCredits: true},
		GeminiKey: []config.GeminiKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g-new", ProxyURL: "http://gp-new"}}, BaseURL: "http://g-new", Headers: map[string]string{"A": "2"}, ExcludedModels: []string{"x", "y"}},
		},
		ClaudeKey: []config.ClaudeKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c-new", ProxyURL: "http://cp-new"}}, BaseURL: "http://c-new", Headers: map[string]string{"H": "2"}, ExcludedModels: []string{"x", "y"}},
		},
		CodexKey: []config.CodexKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x-new", ProxyURL: "http://xp-new"}}, BaseURL: "http://x-new", Headers: map[string]string{"H": "2"}, ExcludedModels: []string{"x", "y"}},
		},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v-new", ProxyURL: "http://vp-new"}}, BaseURL: "http://v-new", Headers: map[string]string{"H": "2"}, Models: []config.VertexCompatModel{{Name: "m1"}, {Name: "m2"}}},
		},
		AmpCode: config.AmpCode{
		...
		OAuthExcludedModels: config.OAuthExcludedModelsConfigFromLegacy(map[string][]string{"p1": {"b", "c"}, "p2": {"d"}}),
		OpenAICompatibility: []config.OpenAICompatibility{
			{
				Name: "prov-old",
				APIKeyEntries: []config.OpenAICompatibilityAPIKey{
	...
	expectContains(t, changes, "gemini[0].api-key-entries: updated (1 -> 1 entries)")
	...
	expectContains(t, changes, "claude[0].api-key-entries: updated (1 -> 1 entries)")
	...
	expectContains(t, changes, "codex[0].api-key-entries: updated (1 -> 1 entries)")
	...
	expectContains(t, changes, "vertex[0].api-key-entries: updated (1 -> 1 entries)")
...
func TestBuildConfigChangeDetails_CountBranches(t *testing.T) {
	oldCfg := &config.Config{}
	newCfg := &config.Config{
		GeminiKey: []config.GeminiKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "g"}}}},
		ClaudeKey: []config.ClaudeKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "c"}}}},
		CodexKey:  []config.CodexKey{{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "x"}}}},
		VertexCompatAPIKey: []config.VertexCompatKey{
			{APIKeyEntries: []config.ProviderAPIKeyEntry{{APIKey: "v"}}, BaseURL: "http://v"},
		},
	}
